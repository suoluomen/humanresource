...
<!-- jQuery UI 1.11.4 -->
<script src="<%=basePath%>static/human/plugins/jQuery/jquery-ui.min.js"></script>
...
<!-- jvectormap -->
<script src="<%=basePath%>static/human/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<%=basePath%>static/human/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="<%=basePath%>static/human/plugins/knob/jquery.knob.js"></script>
<!-- daterangepicker -->
...
<!-- datepicker -->
<script src="<%=basePath%>static/human/plugins/datepicker/bootstrap-datepicker.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="<%=basePath%>static/human/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
